...
// PosmTestSetup deploys PositionManager/PositionDescriptor/proxy via vm.getCode strings. Pull their
// concrete types into this sparse test's import graph so `--match-path` emits the required artifacts.
