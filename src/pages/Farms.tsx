...
export function FarmsPage({ network: _network }: Props) {
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      <div className="mb-6">
        <h1 className="font-display text-2xl font-semibold text-pcs-text">Farms</h1>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-pcs-textDim mt-1 max-w-xs">
            HYDE farming rewards launch when MasterChef deploys to Robinhood L2. LP staking will be available here.
          </p>
        </div>
      </div>
    </div>
